...
def get_data_files():
    ...
    settings = glob.glob("comic/settings/settings.*")
...
def get_requirements():
    ...
    name = "cosmiccc/requirements.txt"
...
def run_setup(data_files, scripts, packages, install_requires):
    ...
    setup(
        ...
        version=VERSION,
        license="MIT",
        description="Cosmic Ray Removal Tool",
        long_description=open("README.md").read(),
        author="A. Floers",
        author_email="floersandreas@gmail.com",
        keywords="Cosmic Ray Removal",
        url="https://github.com/afloers/cosmiccc",
        packages=packages,
        package_data={"cosmiccc": data_files, "": ["*.rst", "*.txt"]},
        python_requires=">=2.7",
